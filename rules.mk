...
# switches to let you include libmaple headers. SD_INCLUDES gives the
# include switches you need for the libSD headers.
CFLAGS_$(d) := $(WIRISH_INCLUDES) $(LIBMAPLE_INCLUDES) $(SD_INCLUDES) $(FAT_INCLUDES)
